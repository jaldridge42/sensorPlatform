...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../sensors_intf.sopcinfo
...
# Design Name 
# setting SOPC_NAME is sensors_intf
SOPC_NAME := sensors_intf
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x21038
SOPC_SYSID_FLAG += --sidp=0x21038
ELF_PATCH_FLAG  += --sidp 0x21038

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1444878925
SOPC_SYSID_FLAG += --timestamp=1444878925
ELF_PATCH_FLAG  += --timestamp 1444878925
